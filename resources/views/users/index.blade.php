        ...
        <table class="table table-bordered border-success w-full">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 border border-green-500">{{ $user->department->name ?? 'N/A' }}</td>
                    <td class="px-4 py-2 border border-green-500">{{ $user->designation->name ?? 'N/A' }}</td>
                    <td class="px-4 py-2 border border-green-500">{{ $user->supervisor->name ?? 'N/A' }}</td>
